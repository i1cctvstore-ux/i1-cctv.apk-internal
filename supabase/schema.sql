...
-- Admin & Super Admin boleh MENGUBAH data karyawan (role/status aktif).
-- Catatan: pembatasan lebih detail (mis. hanya Super Admin yang boleh mengubah
-- akun ber-role Admin/Super Admin lain) BELUM diterapkan di sini — masih level
-- "admin & super_admin sama-sama boleh kelola karyawan" seperti sebelumnya.
